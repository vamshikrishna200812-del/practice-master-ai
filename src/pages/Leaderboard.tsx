    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="bg-gradient-hero text-white rounded-xl p-6 md:p-8">
          ...
          <p className="text-white/80">Top coders ranked by points earned from solving problems.</p>
        </div>
          ...
          {loading ? (
            ...
            <div className="divide-y divide-border">
              ...
              <div className="grid grid-cols-12 gap-2 px-4 py-3 text-xs font-medium text-muted-foreground bg-muted/30">
                ...
                <div className="col-span-3 text-center hidden sm:block">Solved</div>
              ...
              {entries.map((entry, i) => (
                ...
                >
                  ...
                  <div className="col-span-3 text-center hidden sm:flex items-center justify-center gap-1.5">
